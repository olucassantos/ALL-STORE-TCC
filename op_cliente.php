...
if ($acao == "Inserir") {
  ...
  echo "<script type='text/javascript'> alert('Registro inserido com sucesso!'); location.href='login.php' </script> ";
}

if ($acao == "Alterar_cadastro") {
  ...
  echo "<script type='text/javascript'> alert('Registro alterado com sucesso!'); location.href='login.php' </script> ";
}
...
if ($acao == "Excluir") {
  ...
  echo "<script type='text/javascript'> alert('Registro excluído com sucesso!'); location.href='login.php' </script> ";
}
header("Location: painel_cliente.php?id=18");
exit();
?>
