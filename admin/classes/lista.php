	...
	class Lista extends Paginacao{
		...
		public function listaAdministrador(){
			...
			while ($linha = self::results()){
				...
				<td> $linha[nome] </td>
				<td> $linha[login] </td>
				<td> <a href='index.php?link=12&acao=Alterar&id=$linha[id_administracao]'> <img src='imagens/alterar.gif' border='0' /></a> </td>
				<td> <a href='index.php?link=12&acao=Excluir&id=$linha[id_administracao]'> <img src='imagens/excluir.gif' border='0' /></a> </td>		
				</tr>
		...
		public function listaCliente(){
			...
			while ($linha = self::results()){
				...
				<td> $linha[cliente] </td>
				<td> $linha[email] </td>
				<td> <a href='index.php?link=14&acao=Alterar&id=$linha[id_cliente]'> <img src='imagens/alterar.gif' border='0' /></a> </td>
				<td> <a href='index.php?link=14&acao=Excluir&id=$linha[id_cliente]'> <img src='imagens/excluir.gif' border='0' /></a> </td>		
				</tr>
