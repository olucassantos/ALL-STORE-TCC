...
class Paginacao extends conexaoMySQL {
    ...
    protected function iniciaPaginacao() {
        ...
        // cria as conexões
        $this->qrA = $this->executarSQL($this->sqlA);
        $this->qrB = $this->executarSQL($this->sqlB);
        $this->totRegA = $this->contaDados($this->qrA);
        $this->totRegB = $this->contaDados($this->qrB);

        // carrega as variáveis
        $this->resultadoTotal = $this->totRegA;
        $this->resultadoParcial = $this->totRegB;
        $this->resultadoDiv = ceil($this->resultadoTotal / $this->maxPage);
        $this->numeroPaginas = min($this->resultadoDiv, $this->maxLink);
    ...
    protected function results() {
        $this->dadosGerados = $this->listar($this->qrB);
